...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Account Types eg Personal, Company, Broker, it helps in classifying accounts : ';
...
-- Dumping data for table property.contacts: ~1 rows (approximately)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Manage App Packages';
