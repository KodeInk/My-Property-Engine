...
-- Dumping data for table property.property: ~5 rows (approximately)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Property Size';

-- Dumping data for table property.property_size: ~0 rows (approximately)
